...
> **Note:** This repository contains the core code of the Laravel framework. If you want to build an application using Laravel, visit the main [Laravel repository](https://github.com/laravel/laravel). This contain API endpoints for user (registration and login) and post (CRUD). This will act as my API source for all my VUE/REACT/VITE, etc..
> ***
> Command:
> - composer install
> - php artisan migrate
